"""
Train Liu et al. 2022 JAHA model on Pulsewatch data, with four channels of input (not their original type of input).
(experiments/try_10_Liu_JAHA_2022/main_02_train_on_Pulsewatch_four_channels.py)
...
for epoch in range(opt.niter):
    ...
    if (epoch+1) % 5 == 0:
        ...
        if accuracy_score(labelsall, predictions) > ValidAcc:
            ...
            best_model_ckpt_name = 'Liu_JAHA_2022_four_channels_'+fold_name+'_epoch_'+str_epoch+'_ValAcc_'+str_val_acc+'.pt'
