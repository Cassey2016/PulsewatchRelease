"""
Input HR, magnified HR, and ACC (no PPG) for 1D-bi-GRU model.
(DeepBeat/experiments/try_04_run_several_models/run_10_HR_rescaleHR_ACC.py)
Dong, 09/21/2024:
"""
import my_main
import argparse
...
parser.add_argument("--data_dim",type=str, default='1D_HR_rescaleHR_ACC_noPPG') # '1D_PPG', '1D_PPG_HR', '2D_TFS', '2D_Poin', '2D_TFS_HR', '2D_Poin_HR'.
...
# --- Output config ---
parser.add_argument("--filename_output", type=str, default='train_RNN_GRU_20240921_'+fold_name+'.csv') # Default run not on HPC.
parser.add_argument("--output_folder_name",type=str, default='TestRNNGRU_HR_rescaleHR_ACC_noPPG') # 'TestPyTorch'
