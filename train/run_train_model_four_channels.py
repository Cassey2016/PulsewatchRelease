"""
Train a model with four channels of input, PPG, HR, ACC, magnified HR.
(experiments/try_04_run_several_models/run_06_rescale_HR.py)
...
parser.add_argument("--data_dim",type=str, default='1D_PPG_HR_ACC_rescaleHR') # '1D_PPG', '1D_PPG_HR', '2D_TFS', '2D_Poin', '2D_TFS_HR', '2D_Poin_HR'.
...
# --- Model config ---
parser.add_argument("--str_which_model",type=str, default='RNN-GRU') # 'Luis', 'RNN-GRU'.
...
# --- Output config ---
parser.add_argument("--filename_output", type=str, default='train_RNN_GRU_20240712_'+fold_name+'.csv') # Default run not on HPC.
parser.add_argument("--output_folder_name",type=str, default='TestRNNGRU_HR_ACC_rescaleHR') # 'TestPyTorch'
