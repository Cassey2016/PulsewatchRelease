"""
Input PPG and ACC to the 1D-bi-GRU model.
(DeepBeat/experiments/try_04_run_several_models/run_07_PPG_ACC_only.py)
Dong, 09/17/2024.
"""
import my_main
import argparse
...
parser.add_argument("--data_dim",type=str, default='1D_PPG_ACC_only') # '1D_PPG', '1D_PPG_HR', '2D_TFS', '2D_Poin', '2D_TFS_HR', '2D_Poin_HR'.
...
parser.add_argument("--output_folder_name",type=str, default='TestRNNGRU_PPG_ACC_only') # 'TestPyTorch'
