"""
Train 1D RNN GRU model with 1D PPG only input.
(experiments/try_04_run_several_models/run_01.py)
...
parser.add_argument("--data_dim",type=str, default='1D_PPG') # '1D_PPG', '1D_PPG_HR', '2D_TFS', '2D_Poin', '2D_TFS_HR', '2D_Poin_HR'.
...
# --- Output config ---
parser.add_argument("--filename_output", type=str, default='train_RNN_GRU_20240612_'+fold_name+'.csv') # Default run not on HPC.
parser.add_argument("--output_folder_name",type=str, default='TestRNNGRU') # 'TestPyTorch'
