"""
Input PPG and HR to 1D-bi-GRU model.
(DeepBeat/experiments/try_04_run_several_models/run_02_fold_1.py)
Dong, 06/25/2024.
"""
import my_main
import argparse
...
parser.add_argument("--data_dim",type=str, default='1D_PPG_HR') # '1D_PPG', '1D_PPG_HR', '2D_TFS', '2D_Poin', '2D_TFS_HR', '2D_Poin_HR'.
...
# --- Output config ---
parser.add_argument("--filename_output", type=str, default='train_RNN_GRU_20240629_'+fold_name+'.csv') # Default run not on HPC.
parser.add_argument("--output_folder_name",type=str, default='TestRNNGRU_HR') # 'TestPyTorch'
