"""
Test the model that uses all four channels of inputs.
(experiments/try_04_run_several_models/test_run_06_fold_1.py)
...
dict_paths_ckpt = my_pathdef.my_ckpt_path_2024_07_16(flag_Colab, fold_name)
