"""
Test the model with PPG and HR as inputs.
(DeepBeat/experiments/try_04_run_several_models/test_run_02_fold_1.py)
Dong, 06/27/2024.
"""
...
data_dim = '1D_PPG_HR' # '1D_PPG', '1D_PPG_HR', '2D_TFS', '2D_Poin', '2D_TFS_HR', '2D_Poin_HR'.
...
filename_output='train_RNN_GRU_20240629_'+fold_name+'.csv' # Default run not on HPC.
output_folder_name='TestRNNGRU_HR' # 'TestPyTorch'
...
dict_paths_ckpt = my_pathdef.my_ckpt_path_2024_07_01(flag_Colab, fold_name)
