"""
Test the model with PPG+HR+ACC as inputs.
(DeepBeat/experiments/try_04_run_several_models/test_run_04_fold_1.py)
Dong, 07/09/2024.
"""
...
data_dim = '1D_PPG_HR_ACC' # '1D_PPG', '1D_PPG_HR', '2D_TFS', '2D_Poin', '2D_TFS_HR', '2D_Poin_HR'.
...
filename_output='train_RNN_GRU_20240708_'+fold_name+'.csv' # Default run not on HPC.
output_folder_name='TestRNNGRU_HR_ACC' # 'TestPyTorch'
...
dict_paths_ckpt = my_pathdef.my_ckpt_path_2024_07_09(flag_Colab, fold_name)
