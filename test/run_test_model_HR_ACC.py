"""
Test the model that only uses HR and ACC as input.
(experiments/try_04_run_several_models/test_run_05_fold_1.py)
...
data_dim = '1D_HR_ACC' # '1D_PPG', '1D_PPG_HR', '2D_TFS', '2D_Poin', '2D_TFS_HR', '2D_Poin_HR'.
...
filename_output='train_RNN_GRU_20240710_'+fold_name+'.csv' # Default run not on HPC.
output_folder_name='TestRNNGRU_HR_ACC_noPPG' # 'TestPyTorch'
...
dict_paths_ckpt = my_pathdef.my_ckpt_path_2024_07_12(flag_Colab, fold_name)
...
if data_dim == '1D_PPG_HR_ACC' or data_dim == '1D_HR_ACC':
