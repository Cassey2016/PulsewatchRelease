"""
Test model with only HR as input.
(DeepBeat/experiments/try_04_run_several_models/test_run_08_HR_only.py)
Dong, 09/19/2024.
"""
...
data_dim = '1D_HR_only' # '1D_PPG', '1D_PPG_HR', '2D_TFS', '2D_Poin', '2D_TFS_HR', '2D_Poin_HR'.
...
output_folder_name='TestRNNGRU_HR_only' # 'TestPyTorch'
...
dict_paths_ckpt = my_pathdef.my_ckpt_path_2024_09_19_HR_only(flag_Colab, fold_name)
