"""
Test model using HR + magnifiedHR + ACC as input.
(DeepBeat/experiments/try_04_run_several_models/test_10_run_HR_rescaleHR_ACC.py)
Dong, 09/21/2024.
"""
...
data_dim = '1D_HR_rescaleHR_ACC_noPPG' # '1D_PPG', '1D_PPG_HR', '2D_TFS', '2D_Poin', '2D_TFS_HR', '2D_Poin_HR'.
...
filename_output='train_RNN_GRU_20240921_'+fold_name+'.csv' # Default run not on HPC.
output_folder_name='TestRNNGRU_HR_rescaleHR_ACC_noPPG' # 'TestPyTorch'
...
dict_paths_ckpt = my_pathdef.my_ckpt_path_2024_09_21_HR_rescaleHR_ACC_noPPG(flag_Colab, fold_name)
...
if data_dim == '1D_PPG_HR_ACC' or data_dim == '1D_HR_ACC' or data_dim == '1D_PPG_HR_ACC_rescaleHR'\
    or data_dim == '1D_PPG_ACC_only' or data_dim == '1D_HR_rescaleHR_ACC_noPPG':
...
if data_dim[:3] == '1D_':
    ...
    elif data_dim == '1D_PPG_HR_ACC' or data_dim == '1D_HR_rescaleHR_ACC_noPPG':
