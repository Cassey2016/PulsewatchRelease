"""
Calculate the metrics for independent NSR subjects into binary.
Dong, 09/13/2024.
Copied from /mnt/r/ENGR_Chon/Dong/Github_private/Pulsewatch_labeling/DeepBeat/experiments/try_07_eval_models/main_04_independent_NSR.py
"""
import os
import torch
import pandas as pd
...
# if True:
    ...
    test_name = 'remain_NSR_binary_combined_subject_independent_test'
